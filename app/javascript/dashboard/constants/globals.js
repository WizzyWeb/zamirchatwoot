export default {
  ...
  DOCS_URL: '//www.mycodek.com/docs/product/',
  HELP_CENTER_DOCS_URL: '//www.mycodek.com/docs/product/others/help-center',
  TESTIMONIAL_URL: 'https://testimonials.cdn.mycodek.com/content.json',
